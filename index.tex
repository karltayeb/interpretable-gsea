...
\hypersetup{
  pdftitle={Interpretable Gene Set Enrichment Analysis},
  pdfauthor={Karl Tayeb},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{geneSet)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{geneSetDes)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dim}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{X)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gibss }\OtherTok{\textless{}{-}}\NormalTok{ reticulate}\SpecialCharTok{::}\FunctionTok{import}\NormalTok{(}\StringTok{\textquotesingle{}gibss\textquotesingle{}}\NormalTok{)}

\CommentTok{\# get simulation from python session}
\CommentTok{\# just because we want to keep the }
\NormalTok{X }\OtherTok{\textless{}{-}}\NormalTok{ py}\SpecialCharTok{$}\NormalTok{X}
\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ py}\SpecialCharTok{$}\NormalTok{y}

\NormalTok{tictoc}\SpecialCharTok{::}\FunctionTok{tic}\NormalTok{(}\StringTok{\textquotesingle{}fitting SER\textquotesingle{}}\NormalTok{)}
\NormalTok{serfit }\OtherTok{\textless{}{-}}\NormalTok{ gibss}\SpecialCharTok{$}\NormalTok{susie}\SpecialCharTok{$}\FunctionTok{fit\_logistic\_susie2}\NormalTok{(X, y, }\AttributeTok{L=}\DecValTok{1}\NormalTok{, }\AttributeTok{maxiter=}\DecValTok{1}\NormalTok{)}
\NormalTok{tictoc}\SpecialCharTok{::}\FunctionTok{toc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
fitting SER: 20.903 sec elapsed
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tictoc}\SpecialCharTok{::}\FunctionTok{tic}\NormalTok{(}\StringTok{\textquotesingle{}fitting SuSiE\textquotesingle{}}\NormalTok{)}
\NormalTok{fit }\OtherTok{\textless{}{-}}\NormalTok{ gibss}\SpecialCharTok{$}\NormalTok{susie}\SpecialCharTok{$}\FunctionTok{fit\_logistic\_susie2}\NormalTok{(X, y, }\AttributeTok{L=}\DecValTok{10}\NormalTok{, }\AttributeTok{maxiter=}\DecValTok{10}\NormalTok{)}
\NormalTok{tictoc}\SpecialCharTok{::}\FunctionTok{toc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
fitting SuSiE: 156.012 sec elapsed
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{compute\_cs }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(alpha, }\AttributeTok{coverage=}\FloatTok{0.95}\NormalTok{)\{}
\NormalTok{  idx }\OtherTok{\textless{}{-}} \FunctionTok{rev}\NormalTok{(}\FunctionTok{order}\NormalTok{(alpha))}
\NormalTok{  mass }\OtherTok{\textless{}{-}} \FunctionTok{cumsum}\NormalTok{(alpha[idx])}
\NormalTok{  last }\OtherTok{=} \FunctionTok{which}\NormalTok{(mass }\SpecialCharTok{\textgreater{}=}\NormalTok{ coverage)[}\DecValTok{1}\NormalTok{]}
\NormalTok{  cs }\OtherTok{\textless{}{-}}\NormalTok{ idx[}\DecValTok{1}\SpecialCharTok{:}\NormalTok{last]}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{cs=}\NormalTok{cs, }\AttributeTok{alpha=}\NormalTok{alpha[cs], }\AttributeTok{coverage =}\NormalTok{ mass[last], }\AttributeTok{target\_coverage=}\NormalTok{coverage))}
\NormalTok{\}}

\NormalTok{gseafit }\OtherTok{\textless{}{-}}\NormalTok{ fit}
\NormalTok{idx }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(py}\SpecialCharTok{$}\NormalTok{beta }\SpecialCharTok{!=}\DecValTok{0}\NormalTok{)}
\NormalTok{alpha }\OtherTok{\textless{}{-}}\NormalTok{ gseafit}\SpecialCharTok{$}\NormalTok{alpha}
\NormalTok{cs }\OtherTok{\textless{}{-}}\NormalTok{ purrr}\SpecialCharTok{::}\FunctionTok{map}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(alpha), }\SpecialCharTok{\textasciitilde{}}\FunctionTok{compute\_cs}\NormalTok{(alpha[.x,]))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# the first 4 components have evidence of association.}
\NormalTok{gseafit}\SpecialCharTok{$}\NormalTok{lbf}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# the CSs fo the first 3 are singletons, }
\CommentTok{\# while the CS for th 4th component has 10 gene sets}
\NormalTok{purrr}\SpecialCharTok{::}\FunctionTok{map\_int}\NormalTok{(cs, }\SpecialCharTok{\textasciitilde{}}\FunctionTok{length}\NormalTok{(.x}\SpecialCharTok{$}\NormalTok{cs))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# the PIP of the top SNP in each CS}
\NormalTok{purrr}\SpecialCharTok{::}\FunctionTok{map\_dbl}\NormalTok{(cs, }\SpecialCharTok{\textasciitilde{}}\NormalTok{.x}\SpecialCharTok{$}\NormalTok{alpha[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# check if the top snp is causal}
\NormalTok{purrr}\SpecialCharTok{::}\FunctionTok{map\_int}\NormalTok{(cs, }\SpecialCharTok{\textasciitilde{}}\NormalTok{.x}\SpecialCharTok{$}\NormalTok{cs[}\DecValTok{1}\NormalTok{]) }\SpecialCharTok{\%in\%}\NormalTok{ idx}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# check which CSs include which of the causal variables}
\NormalTok{incidence }\OtherTok{\textless{}{-}} \FunctionTok{do.call}\NormalTok{(rbind, purrr}\SpecialCharTok{::}\FunctionTok{map}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{, }\SpecialCharTok{\textasciitilde{}}\FunctionTok{as.integer}\NormalTok{(idx }\SpecialCharTok{\%in\%}\NormalTok{ cs[[.x]]}\SpecialCharTok{$}\NormalTok{cs)))}
\FunctionTok{rownames}\NormalTok{(incidence) }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}L\textquotesingle{}}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(incidence))}
\FunctionTok{colnames}\NormalTok{(incidence) }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}GS\textquotesingle{}}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\FunctionTok{ncol}\NormalTok{(incidence))}
\NormalTok{incidence}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{marginal\_analysis }\OtherTok{\textless{}{-}}\NormalTok{ tibble}\SpecialCharTok{::}\FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{GS =} \FunctionTok{colnames}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{X),}
  \AttributeTok{i =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{ncol}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{X),}
  \AttributeTok{lbf=}\NormalTok{serfit}\SpecialCharTok{$}\NormalTok{lbf[}\DecValTok{1}\NormalTok{,],}
  \AttributeTok{effect=}\NormalTok{serfit}\SpecialCharTok{$}\NormalTok{effect[}\DecValTok{1}\NormalTok{,]}
\NormalTok{)}

\NormalTok{marginal\_analysis }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{causal =}\NormalTok{ i }\SpecialCharTok{\%in\%}\NormalTok{ idx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(lbf)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{rank =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{n}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(causal)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{middle\_gene\_sets }\OtherTok{\textless{}{-}}\NormalTok{ marginal\_analysis }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{causal =}\NormalTok{ i }\SpecialCharTok{\%in\%}\NormalTok{ idx) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(lbf)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{ran =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{n}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{head}\NormalTok{(}\DecValTok{15}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{tail}\NormalTok{(}\DecValTok{12}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  \{.}\SpecialCharTok{$}\NormalTok{i\}}

\NormalTok{Matrix}\SpecialCharTok{::}\FunctionTok{t}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{X[,middle\_gene\_sets]) }\SpecialCharTok{\%*\%}\NormalTok{ (c2}\SpecialCharTok{$}\NormalTok{X[, idx])}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{marginal\_analysis }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{rename}\NormalTok{(}\AttributeTok{geneSet =}\NormalTok{ GS) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{left\_join}\NormalTok{(}\FunctionTok{select}\NormalTok{(c2}\SpecialCharTok{$}\NormalTok{geneSetDes, }\FunctionTok{c}\NormalTok{(geneSet, description))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(}\FunctionTok{c}\NormalTok{(geneSet, description, lbf))}
\end{Highlighting}
\end{Shaded}
